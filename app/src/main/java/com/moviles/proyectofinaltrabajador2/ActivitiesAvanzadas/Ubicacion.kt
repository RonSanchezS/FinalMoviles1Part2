...
import com.moviles.proyectofinaltrabajador2.databinding.ActivityUbicacionBinding
...
class Ubicacion : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val latitud = intent?.extras?.get("latitud").toString().toDouble()
        val longitud = intent?.extras?.get("longitud").toString().toDouble()
